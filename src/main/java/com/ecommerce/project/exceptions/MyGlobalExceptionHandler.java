...
import com.ecommerce.project.payload.ErrorCustomResponse;
...
public class MyGlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorCustomResponse> myResponse(APIException e){
        String message = e.getMessage();
        ErrorCustomResponse errorData = new ErrorCustomResponse<>();
